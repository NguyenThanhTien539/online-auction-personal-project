      ...
      <footer className="bg-gradient-to-br from-gray-800 via-gray-700 to-gray-500 text-white relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-2xl font-bold text-blue-400">AuctionPro</h3>
              </div>
              <p className="text-gray-300 leading-relaxed">
                Nền tảng đấu giá trực tuyến hàng đầu Việt Nam. Mang đến trải
                nghiệm đấu giá công bằng, an toàn và thú vị cho mọi người.
              </p>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-gray-400 text-sm mb-4 md:mb-0">
                ...
                <span className="ml-2 text-blue-400">
                  Made with <Heart size={14} className="inline animate-pulse" />{" "}
                  in Vietnam
                </span>
              </div>
        ...
        <div className="absolute bottom-0 left-0 w-full">
          <svg
            ...
            className="w-full h-12 fill-current text-white opacity-10"
          >
            <path
